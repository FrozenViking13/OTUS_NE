...
В режиме Sticky происходит наполнение таблицы изученными MAC адресами. В моем понимании Remaining Time может не отображаться, если это MAC которые были изучены, но не попали в число разрешенных? А вообще и на S1 оно не отображается, хотя там port-security dynamic. Или это опять ограничение CPT?

2.	Что касается безопасности порта на S2, если вы загружаете скрипт текущей конфигурации на S2, почему порту 18 на PC-B никогда не получит IP-адрес через DHCP?
Потому что по заданию у нас не было команды no ip dhcp snooping information option 
