...
В виду того, что ARP протокол является открытым, он является не безопасным. В крупных сетях отправка ARP запросов влечет за собой дополнительную нагрузку на сеть, по сути кратную количеству устройств, подключенных к этой сети.