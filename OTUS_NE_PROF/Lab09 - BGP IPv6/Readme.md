...
```
Соседство установлено, маршруты до лупбэков прилетели. Вроде ок 
...
Поднял OSPFV3 на R12-R15, анонсировал лупбэки, поднял iBGP между R14-R15
Конфиги:
<details>
<summary>R12</summary>
<pre><code>
...
На роутерах Триады в ISIS аноннсировал IPv6 лупбэки, создал пиргруппу для IPv6 и поднял RR
...
```
Выглядит рабочим, хотя маршруты в таблице ISIS в виду меньшей AD