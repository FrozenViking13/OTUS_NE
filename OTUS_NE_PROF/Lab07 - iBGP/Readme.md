...
## Настроите iBGP в офисом Москва между маршрутизаторами R14 и R15.     
Прямой смычки между R14 и R15 у нас нет, но есть пути через R12 и R13, а там крутится OSPF и маршруты до лупбэков уже есть. iBGP соседство можно построить по Lo0
...
Вот тут было весело, апдейты не приходили как надо, по ходу EVE глюкнул, и отвалилась даже межвлановая маршрутизация.После рестарта всех устройств все внезапно начало работать.
В кратце, пишем route-mapЫ на R15 на увеличение Local preference, а на R14 накидываем препенды. Заодно сделал редистрибьюцию OSPF и EIGRP в BGP
...
Тут видим частные сетки хостовые, что не есть хорошо, судя по всему надо фильтровать.
...
Так понимаю, фильтрацией надо будет заняться в следующем ДЗ. Оно как раз на эту тему. Там с R22 и разберемся :)
