...
## Подготовка
Сначала запустим процесс EIGRP и анонсируем  сети на всех L3 устройствах, а потом займемся суммаризацией и фильтрацией и выполним проверки.
...
Свитчи у меня в L3, на них тоже поднимаем EIGRP и анонсируем сети хостов VPC.
...
Соседство установилось. Заглянем в таблицу маршрутизации:
```
...
Сначала пропишем статикой маршрут по умолчанию на R18 и сделаем его редистрибьюцию:
```
